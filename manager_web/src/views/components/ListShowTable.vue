        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="状态">
                    <el-input v-model="form.activeFlag"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    export default {
        ...
        methods: {
            getData(pageNum) {
                const url = this.commRouter + '/listShow/list4Manager';
            ...
            saveEdit() {
                ...
                const url = this.commRouter + '/listShow/update';
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('删除后不可恢复，确定吗？', '提示', {
                    ...
                    .then(() => {
                        const url = this.commRouter + '/listShow/delete?id=' + row.id;
